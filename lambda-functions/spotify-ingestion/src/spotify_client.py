...
class SpotifyClient:
    ...
    def authenticate(self) -> None:
        ...
        Creates a Spotify client with required scopes for reading
        recently played tracks and user library.
        ...
        try:
            auth_manager = SpotifyOAuth(
                ...
                scope=scope,
                cache_path=".spotify_cache",  # TODO: Store in S3 for Lambda
                open_browser=True  # Set to False in Lambda
            )
